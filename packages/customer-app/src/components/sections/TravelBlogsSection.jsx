...
const BlogCard = ({ post, language, isRTL }) => {
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="w-full shadow-lg shadow-black/30 mb-4">
        <div className="relative h-0 w-full overflow-hidden pb-[60%]">
          {post.featuredImage ? (
            ...
            <div className="absolute inset-0 size-full bg-white/5 flex items-center justify-center">
              <span className="text-text-muted/70 text-sm">eSIM</span>
            </div>
          )}
        </div>
      </div>
...
const SkeletonCard = () => (
  <div className="flex flex-col animate-pulse">
    <div className="w-full mb-4">
      <div className="relative h-0 w-full pb-[60%] bg-white/5 rounded" />
    </div>
    <div className="flex-1">
      <div className="h-5 w-16 bg-white/5 rounded-full mb-2" />
