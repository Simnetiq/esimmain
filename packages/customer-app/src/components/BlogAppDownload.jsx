          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className={`mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row ${currentIsRTL ? 'sm:flex-row-reverse' : ''}`}>
              ...
              <a
                ...
                className={`group inline-flex items-center gap-3 rounded-full bg-gray-900 px-6 py-3 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:bg-gray-800 hover:scale-105 ${currentIsRTL ? 'flex-row-reverse' : ''}`}
              >
              ...
              <a
                ...
                className={`group inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 text-sm font-medium text-gray-900 ring-1 ring-gray-200 shadow-sm transition-all duration-200 hover:bg-gray-50 hover:scale-105 ${currentIsRTL ? 'flex-row-reverse' : ''}`}
              >
