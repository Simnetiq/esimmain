...
const BlogAppDownload = ({
  ...
  // Language detection with fallback - prioritize i18n context
  ...
  }, [locale, language, i18nLoading]);

  const direction = getLanguageDirection(detectedLanguage);
  const currentIsRTL = isRTL !== undefined ? isRTL : (direction === 'rtl');
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className={`mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row ${currentIsRTL ? 'sm:flex-row-reverse' : ''}`}>
              ...
              <a
                ...
                className={`group inline-flex items-center rounded-full bg-white/10 pl-6 pr-1.5 py-1.5 text-base font-semibold text-white shadow-lg transition-all duration-200 hover:bg-white/20 hover:scale-[1.02] w-full sm:w-auto`}
              >
                <span className="flex-1 text-center">{t('blogApp.getApp', 'App Store')}</span>
                <span className="ml-3 flex-shrink-0 inline-flex items-center justify-center rounded-full bg-white w-9 h-9">
              ...
              <a
                ...
                className={`group inline-flex items-center rounded-full bg-white pl-6 pr-1.5 py-1.5 text-base font-semibold text-gray-900 ring-1 ring-gray-200 shadow-sm transition-all duration-200 hover:bg-gray-50 hover:scale-[1.02] w-full sm:w-auto`}
              >
                <span className="flex-1 text-center">{t('blogApp.getAndroidApp', 'Google Play')}</span>
                <span className="ml-3 flex-shrink-0 inline-flex items-center justify-center rounded-full bg-gray-100 w-9 h-9">
